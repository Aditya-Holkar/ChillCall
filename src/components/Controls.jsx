...
export default function Controls({
  ...
  return (
    <div className="flex items-center justify-center gap-2 px-4 py-3 bg-coral-50 dark:bg-coral-900 border-t border-coral-200 dark:border-coral-800">
      ...
      <div className="w-px h-8 bg-coral-300 dark:bg-coral-700 mx-1" />
